...
module.exports = withFailureReporting('api/lead-enrich', async function handler(req, res) {
  ...
  if (rateLimited(req, res, { name: 'lead-enrich', max: 20, windowMs: 60 * 1000, auth: auth })) return;
