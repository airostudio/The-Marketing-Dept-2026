...
module.exports = withFailureReporting('api/nancy-strategy', async function handler(req, res) {
  ...
  if (rateLimited(req, res, { name: 'nancy-strategy', max: 8, windowMs: 60 * 1000, auth })) return;
