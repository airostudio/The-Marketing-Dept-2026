...
import type { BrandProfile, AdBrief, AdConcept, LayoutSpec, CampaignResult, CampaignDraft } from '../types.js';
...
export const campaignDraftStore = new JsonStore<CampaignDraft>(DATA_DIR, 'campaign-drafts.json');
