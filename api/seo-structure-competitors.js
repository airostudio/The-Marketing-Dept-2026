...
module.exports = withFailureReporting('api/seo-structure-competitors', async function handler(req, res) {
  ...
  if (rateLimited(req, res, { name: 'seo-structure-competitors', max: 8, windowMs: 60 * 1000, auth })) return;
